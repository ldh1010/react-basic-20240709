...
// XML의 형태와 유ㅜ사하고 DOM 트리를 생성하는 JS, TS 확장자

// 컴포넌트
// 화면에 표시되는 하나의 요소 단위
// 각각의 독립적인 상태와 로직을 가지고 있음
// 클래스형 컴포넌트, 함수형 컴포넌트 존재
// 클래스형 컴포넌트는 이제 사용되지 않음, 함수형 컴포넌트만 사용됨
...
// - rendet() 메서드의 반환값으로 렌더링하고자하는 요소를 반환
...
export default function Component () {
    ...
    // - 부모요소로 묶을 때 <></>를 이용하여 의미없는 태그를 생성 할 수 있음
